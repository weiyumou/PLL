...
python run_pll.py --deterministic --data_root ../wikipedia/en_wiki_out.txt  --sents_per_doc 32 --max_seq_len 64 --num_derangements 9 --max_steps 1000000 --per_gpu_train_batch_size 32 --per_gpu_eval_batch_size 32 --logging_steps 2000 --save_steps 2000 --fp16
